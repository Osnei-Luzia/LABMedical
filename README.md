...
O LABMedical gere três principais bancos de informações para seu hospital: Pacientes, Consultas e Exames. Possibilitando Criação, Remoção e Edição de informações de forma dinâmica e segura.
...
<img src="placeholder" width="600"><br>
